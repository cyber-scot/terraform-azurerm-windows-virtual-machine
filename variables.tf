...
variable "computer_name" {
  type        = string
  description = "The computer name of the host if specified, this module will attempt to use var.name by sanitising it"
  default     = null
}
...
variable "name" {
  type        = string
  description = "The name to be used within this module for the name of the VM"
}

variable "nic_ipconfig_name" {
  type        = string
  description = "The name of the NIC IPconfig if specified"
  default     = null
}

variable "nic_name" {
  type        = string
  description = "Specify the name of a NIC, if specified"
  default     = null
}

variable "os_disk_caching" {
  type        = string
  description = "The type of caching for the OS disk"
  default     = "ReadWrite"
}

variable "os_disk_name" {
  type        = string
  description = "The name of the OS disk if specified"
  default     = null
}
